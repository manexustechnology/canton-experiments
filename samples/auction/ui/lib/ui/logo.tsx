/**
 * Logo — the Tenzro mark. Vendored verbatim from @tenzro/ui
 * (wallet/logo.tsx).
 */
...
export function Logo({ size = 28, withWordmark = false, className }: LogoProps) {
  return (
    <span className={cn('inline-flex items-center gap-2', className)}>
      ...
      >
        <defs>
          <linearGradient id="tenzro-mark-bg" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="oklch(0.7 0.18 285)" />
            <stop offset="1" stopColor="oklch(0.62 0.2 295)" />
          </linearGradient>
          <linearGradient id="tenzro-mark-fg" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
