/**
 * KeyStat — labelled large-number tile. Vendored from @tenzro/ui
 * (wallet/key-stat.tsx).
 */
...
export function KeyStat({ label, value, delta, icon: Icon, accent = 'brand', className }: KeyStatProps) {
  return (
    <div
      className={cn(
