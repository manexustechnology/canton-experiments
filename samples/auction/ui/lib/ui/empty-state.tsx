/**
 * EmptyState — "no auctions yet" placeholder. Vendored from @tenzro/ui
 * (wallet/empty-state.tsx).
 */
...
export function EmptyState({ icon: Icon, title, description, children, className }: EmptyStateProps) {
  return (
    <div
      className={cn('flex flex-col items-center justify-center text-center gap-3 px-6 py-12', className)}
    >
